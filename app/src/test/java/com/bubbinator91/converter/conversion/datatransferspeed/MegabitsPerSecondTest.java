...
public class MegabitsPerSecondTest {
    ...
    public void testToAll() throws Exception {
        ...
        MegabitsPerSecond.toAll("8009.976435623164", 10)
                .subscribe(results -> {
        ...
        MegabitsPerSecond.toAll("8009.976435623164", 5)
                .subscribe(results -> {
                    assertNotNull(results);
    ...
    public void testToBitsPerSecond() throws Exception {
        assertEquals("8009976435.623164",
                MegabitsPerSecond.toBitsPerSecond("8009.976435623164", 10));
        assertEquals("8009976435.62316",
                MegabitsPerSecond.toBitsPerSecond("8009.976435623164", 5));
    }

    @Test
    public void testToBytesPerSecond() throws Exception {
        assertEquals("1001247054.4528955",
                MegabitsPerSecond.toBytesPerSecond("8009.976435623164", 10));
        assertEquals("1001247054.4529",
                MegabitsPerSecond.toBytesPerSecond("8009.976435623164", 5));
    }

    @Test
    public void testToKilobitsPerSecond() throws Exception {
        assertEquals("8009976.435623164",
                MegabitsPerSecond.toKilobitsPerSecond("8009.976435623164", 10));
        assertEquals("8009976.43562",
                MegabitsPerSecond.toKilobitsPerSecond("8009.976435623164", 5));
    }

    @Test
    public void testToKilobytesPerSecond() throws Exception {
        assertEquals("1001247.0544528955",
                MegabitsPerSecond.toKilobytesPerSecond("8009.976435623164", 10));
        assertEquals("1001247.05445",
                MegabitsPerSecond.toKilobytesPerSecond("8009.976435623164", 5));
    }

    @Test
    public void testToMegabytesPerSecond() throws Exception {
        assertEquals("1001.2470544529",
                MegabitsPerSecond.toMegabytesPerSecond("8009.976435623164", 10));
        assertEquals("1001.24705",
                MegabitsPerSecond.toMegabytesPerSecond("8009.976435623164", 5));
    }

    @Test
    public void testToGigabitsPerSecond() throws Exception {
        assertEquals("8.0099764356",
                MegabitsPerSecond.toGigabitsPerSecond("8009.976435623164", 10));
        assertEquals("8.00998",
                MegabitsPerSecond.toGigabitsPerSecond("8009.976435623164", 5));
    }

    @Test
    public void testToGigabytesPerSecond() throws Exception {
        assertEquals("1.0012470545",
                MegabitsPerSecond.toGigabytesPerSecond("8009.976435623164", 10));
        assertEquals("1.00125",
                MegabitsPerSecond.toGigabytesPerSecond("8009.976435623164", 5));
    }

    @Test
    public void testToTerabitsPerSecond() throws Exception {
        assertEquals("0.0080099764",
                MegabitsPerSecond.toTerabitsPerSecond("8009.976435623164", 10));
        assertEquals("0.00801",
                MegabitsPerSecond.toTerabitsPerSecond("8009.976435623164", 5));
    }

    @Test
    public void testToTerabytesPerSecond() throws Exception {
        assertEquals("0.0010012471",
                MegabitsPerSecond.toTerabytesPerSecond("8009.976435623164", 10));
        assertEquals("0.001",
                MegabitsPerSecond.toTerabytesPerSecond("8009.976435623164", 5));
    }
}
...
public class MilesTest {
    ...
    public void testToAll() throws Exception {
        ...
        Miles.toAll("8.569852369523695441288", 10)
                .subscribe(results -> {
        ...
        Miles.toAll("8.569852369523695441288", 5)
                .subscribe(results -> {
                    assertNotNull(results);

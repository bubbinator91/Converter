...
/**
 * An implementation of {@link AsyncTask} that will handle the conversion from meters to the other
 ...
 * round to.
 */
public class FromMetersTask
        extends AsyncTask<String, Void, Pair<List<String>, ConversionErrorCodes>> {
    protected final String TAG = FromMetersTask.class.getSimpleName();
    ...
    protected Pair<List<String>, ConversionErrorCodes> doInBackground(String... params) {
        ...
        try {
            return Meters.toAll(params[0], Integer.parseInt(params[1]));

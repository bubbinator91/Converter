...
/**
 * An implementation of {@link AsyncTask} that will handle the conversion from kelvin to the other
 ...
 * round to.
 */
public class FromKelvinTask
        extends AsyncTask<String, Void, Pair<List<String>, ConversionErrorCodes>> {
    protected final String TAG = FromKelvinTask.class.getSimpleName();
    ...
    protected Pair<List<String>, ConversionErrorCodes> doInBackground(String... params) {
        ...
        try {
            return Kelvin.toAll(params[0], Integer.parseInt(params[1]));

package com.bubbinator91.converter.tasks.temperature;
...
/**
 * An implementation of {@link AsyncTask} that will handle the conversion from fahrenheit to the
 * other temperature values in a separate thread.
 *
 ...
 * round to.
 */
public class FromFahrenheitTask
        extends AsyncTask<String, Void, Pair<List<String>, ConversionErrorCodes>> {
    protected final String TAG = FromFahrenheitTask.class.getSimpleName();
    ...
    protected Pair<List<String>, ConversionErrorCodes> doInBackground(String... params) {
        ...
        try {
            return Fahrenheit.toAll(params[0], Integer.parseInt(params[1]));

...
/**
 * An implementation of {@link AsyncTask} that will handle the conversion from bits per second to
 ...
 * round to.
 */
public class FromBitsPerSecondTask
        extends AsyncTask<String, Void, Pair<List<String>, Integer>> {
    protected final String TAG = FromBitsPerSecondTask.class.getSimpleName();
    ...
    protected Pair<List<String>, Integer> doInBackground(String... params) {
        ...
        try {
            return BitsPerSecond.toAll(params[0], Integer.parseInt(params[1]));

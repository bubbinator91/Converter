...
/**
 * An implementation of {@link AsyncTask} that will handle the conversion from feet per second
 ...
 * round to.
 */
public class FromFeetPerSecondSquaredTask
        extends AsyncTask<String, Void, Pair<List<String>, ConversionErrorCodes>> {
    protected final String TAG = FromFeetPerSecondSquaredTask.class.getSimpleName();
    ...
    protected Pair<List<String>, ConversionErrorCodes> doInBackground(String... params) {
        ...
        try {
            return FeetPerSecondSquared.toAll(params[0], Integer.parseInt(params[1]));

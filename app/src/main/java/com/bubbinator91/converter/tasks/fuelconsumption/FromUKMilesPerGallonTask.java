...
/**
 * An implementation of {@link AsyncTask} that will handle the conversion from UK miles per gallon
 ...
 * round to.
 */
public class FromUKMilesPerGallonTask
        extends AsyncTask<String, Void, Pair<List<String>, Integer>> {
    protected final String TAG = FromUKMilesPerGallonTask.class.getSimpleName();
    ...
    protected Pair<List<String>, Integer> doInBackground(String... params) {
        ...
        try {
            return UKMilesPerGallon.toAll(params[0], Integer.parseInt(params[1]));

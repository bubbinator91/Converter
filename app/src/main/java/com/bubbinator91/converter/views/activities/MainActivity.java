...
/**
 * The main activity of the application. Inherits from the BaseActivity, uses a toolbar, and
 * implements a navigation drawer. The navigation drawer is used to switch between fragments, with
 * each of the said fragments implementing functionality for converting between units of a specific
 * category or class.
 */

...
/**
 * The base activity that all activities should inherit from. This activity is specially created to
 * handle the initialization of the toolbar. It expects that you are using a theme that disables the
 * Action Bar (ex. Theme.AppCompat.NoActionBar).
 */

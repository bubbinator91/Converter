...
public class TemperatureFragment2
        extends BaseFragment2<ITemperaturePresenter2>
        implements ITemperatureView2 {
    private final String TAG = TemperatureFragment2.class.getSimpleName();
    ...
    @Inject ITemperaturePresenter2 temperaturePresenter;
    ...
    @Override
    public void showNewValuesFromModelExcludingSource(TemperatureModel model, TemperatureValues source) {
    ...
    @Override
    public void showErrorForSource(Throwable error, TemperatureValues source) {
    ...
    @Override
    protected ITemperaturePresenter2 getPresenter() {

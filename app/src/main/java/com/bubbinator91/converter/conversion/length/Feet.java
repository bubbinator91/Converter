...
public class Feet extends Unit {
     ...
     *           {@link List} containing the equivalent inches, yards, miles, millimeters,
     ...
     *           point), a null value if the <code>feet</code> parameter is null, or an error if an
     *           {@link Exception} was thrown.
     */
    public static Observable<List<String>> toAll(final String feet, final int decimalPlaces) {

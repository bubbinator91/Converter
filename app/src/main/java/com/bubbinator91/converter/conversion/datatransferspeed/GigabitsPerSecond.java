...
public class GigabitsPerSecond extends Unit {
     ...
     *           <code>gbps</code> parameter is null, or an error if an {@link Exception} was
     *           thrown.
     */
    public static Observable<List<String>> toAll(final String gbps, final int decimalPlaces) {

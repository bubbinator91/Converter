...
/**
 * Handles the conversion from gigabytes per second to other units of length
 */
public class GByps {
    private static final String TAG = "GByps";

    /**
     * Static method that takes in the gigabytes per second value as a {@link String} and converts
     ...
     * per second.
     *
     * @param gbyps             The gigabytes per second value as a {@link String}. Cannot be null.
     ...
     *          order.
     */
    public static ArrayList<String> toAll(@NonNull String gbyps, int roundingLength) {
        Timber.tag(TAG + ".toAll").i("Entered");
        Timber.tag(TAG + ".toAll").i("gbyps = " + gbyps);
        int decimalPlaces = (roundingLength < 0) ? 0 : roundingLength;
        ArrayList<String> results = new ArrayList<>();
        if (Utils.isNumeric(gbyps)) {
            try {
                results.add(toBps(gbyps, decimalPlaces));
                results.add(toByps(gbyps, decimalPlaces));
                results.add(toKbps(gbyps, decimalPlaces));
                results.add(toKByps(gbyps, decimalPlaces));
                results.add(toMbps(gbyps, decimalPlaces));
                results.add(toMByps(gbyps, decimalPlaces));
                results.add(toGbps(gbyps, decimalPlaces));
                results.add(toTbps(gbyps, decimalPlaces));
                results.add(toTByps(gbyps, decimalPlaces));
     ...
     */
    public static String toBps(@NonNull String gbyps, int roundingLength) {
     ...
     * @throws  NumberFormatException
     */
    public static String toByps(@NonNull String gbyps, int roundingLength) {
     ...
     * @throws  NumberFormatException
     */
    public static String toKbps(@NonNull String gbyps, int roundingLength) {
     ...
     * @throws  NumberFormatException
     */
    public static String toKByps(@NonNull String gbyps, int roundingLength) {
     ...
     * @throws  NumberFormatException
     */
    public static String toMbps(@NonNull String gbyps, int roundingLength) {
     ...
     * @throws  NumberFormatException
     */
    public static String toMByps(@NonNull String gbyps, int roundingLength) {
     ...
     * @throws  NumberFormatException
     */
    public static String toGbps(@NonNull String gbyps, int roundingLength) {
     ...
     * @throws  NumberFormatException
     */
    public static String toTbps(@NonNull String gbyps, int roundingLength) {
     ...
     * @throws  NumberFormatException
     */
    public static String toTByps(@NonNull String gbyps, int roundingLength) {

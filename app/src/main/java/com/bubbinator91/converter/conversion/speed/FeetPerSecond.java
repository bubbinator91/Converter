...
public class FeetPerSecond extends Unit {
     ...
     *           {@link List} containing the equivalent knots, kilometers per hour, meters per
     ...
     *           point), a null value if the <code>fps</code> parameter is null, or an error if an
     *           {@link Exception} was thrown.
     */
    public static Observable<List<String>> toAll(final String fps, final int decimalPlaces) {
    ...
    /**
     * Takes in the feet per second value as a {@link String} and converts it to kilometers per
     * hour.
     *
     * @param fps               The feet per second value as a {@link String}. Should not be null.
     * @param decimalPlaces     The number of decimal places to round to. If below zero, will be

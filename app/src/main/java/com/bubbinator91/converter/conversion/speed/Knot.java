...
public class Knot {
    ...
    /**
     * Static method that takes in the knot value as a {@link String} and converts it to feet per
     * second, kilometers per hour, meters per second, and miles per hour.
     *
     ...
     *
     * @return  The equivalent feet per second, kilometers per hour, meters per second, and miles
     *          per hour. values stored in an {@link ArrayList}, in that order.
     */
    ...
    /**
     * Static method that takes in the knot value as a {@link String} and converts it to
     * feet per second.
     *
     * @param knot              The knot value as a {@link String}. Cannot be null.
     * @param roundingLength    The number of decimal places to round to. If below zero, will be
    ...
    /**
     * Static method that takes in the knot value as a {@link String} and converts it to kilometers
     * per hour.
     *
     * @param knot              The knot value as a {@link String}. Cannot be null.
     * @param roundingLength    The number of decimal places to round to. If below zero, will be
    ...
    /**
     * Static method that takes in the knot value as a {@link String} and converts it to meters per
     * second.
     *
     * @param knot              The knot value as a {@link String}. Cannot be null.
     * @param roundingLength    The number of decimal places to round to. If below zero, will be
    ...
    /**
     * Static method that takes in the knot value as a {@link String} and converts it to miles per
     * hour.
     *
     * @param knot              The knot value as a {@link String}. Cannot be null.
     * @param roundingLength    The number of decimal places to round to. If below zero, will be

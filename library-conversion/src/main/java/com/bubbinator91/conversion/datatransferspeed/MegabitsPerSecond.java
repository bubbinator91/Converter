...
public class MegabitsPerSecond extends Unit {
    private static final String TAG = MegabitsPerSecond.class.getSimpleName();
     ...
     *          is null;
     */
    public static Tuple<List<String>, ConversionErrorCodes> toAll(String mbps, int decimalPlaces) {
        if (mbps == null) {
            return null;
        }

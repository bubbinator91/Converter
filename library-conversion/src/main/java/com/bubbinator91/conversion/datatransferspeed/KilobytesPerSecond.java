...
public class KilobytesPerSecond extends Unit {
    private static final String TAG = KilobytesPerSecond.class.getSimpleName();
     ...
     *          found in {@link ConversionErrorCodes}, or null if the <code>kbyps</code> parameter
     *          is null;
     */
    public static Tuple<List<String>, ConversionErrorCodes> toAll(String kbyps, int decimalPlaces) {
        if (kbyps == null) {
            return null;
        }

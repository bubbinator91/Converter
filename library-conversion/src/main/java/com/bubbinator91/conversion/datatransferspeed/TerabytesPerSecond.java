...
public class TerabytesPerSecond extends Unit {
    private static final String TAG = TerabytesPerSecond.class.getSimpleName();
     ...
     *          is null;
     */
    public static Tuple<List<String>, ConversionErrorCodes> toAll(String tbyps, int decimalPlaces) {
        if (tbyps == null) {
            return null;
        }

...
public class KilobitsPerSecond extends Unit {
    private static final String TAG = KilobitsPerSecond.class.getSimpleName();
     ...
     *          found in {@link ConversionErrorCodes}, or null if the <code>kbps</code> parameter is
     *          null;
     */
    public static Tuple<List<String>, ConversionErrorCodes> toAll(String kbps, int decimalPlaces) {
        if (kbps == null) {
            return null;
        }

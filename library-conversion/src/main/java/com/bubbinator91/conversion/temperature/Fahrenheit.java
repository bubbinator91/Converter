...
public class Fahrenheit extends Unit {
     ...
     *          {@link ConversionErrorCodes}, or null if the <code>fahrenheit</code> parameter is
     *          null.
     */
    public static Pair<List<String>, ConversionErrorCodes> toAll(String fahrenheit, int decimalPlaces) {
        if (fahrenheit == null) {
            return null;
        }

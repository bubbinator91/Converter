...
public class Kelvin extends Unit {
     ...
     *          {@link ConversionErrorCodes}, or null if the <code>kelvin</code> parameter is null.
     */
    public static Pair<List<String>, ConversionErrorCodes> toAll(String kelvin, int decimalPlaces) {
        if (kelvin == null) {
            return null;
        }
